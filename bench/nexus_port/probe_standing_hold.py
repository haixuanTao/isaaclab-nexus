...
cfg = load_cfg_from_registry(TASK, "env_cfg_entry_point"); cfg.scene.num_envs = N; cfg.seed = 42; agent_cfg = load_cfg_from_registry(TASK, "rsl_rl_cfg_entry_point")
...
if BACKEND == "nexus": nexusify(cfg, G1, agent_cfg=agent_cfg)
