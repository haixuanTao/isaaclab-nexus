...
( env HOME=/root OMNI_KIT_ACCEPT_EULA=YES \
    ...
    AGILE_NEWTON_DC_ENVELOPE=1 AGILE_NEWTON_LIMIT_SOLREF=0.02,1 AGILE_NEWTON_VEL_CLAMP=1 AGILE_NEWTON_VEL_CLAMP_STATS=1 AGILE_NAN_WATCHDOG=1 AGILE_NEWTON_NAN_QUARANTINE=1 AGILE_NEWTON_RESET_WARMSTART=1 AGILE_CLIP_ACTIONS=10 \
