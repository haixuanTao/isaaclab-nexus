...
# local imports
import sys as _s0; _s0.path.insert(0, '/workspace/WBC-AGILE/scripts')  # ablation harness
...
# --- ABLATION HARNESS (added by /workspace/bench, AGILE repo unmodified) ---
import sys as _sys
_sys.path.insert(0, '/workspace/bench/scripts')
import ablate_patch  # noqa: F401,E402  applies AGILE_ABLATE / AGILE_NVTX
# --- END ABLATION HARNESS ---
